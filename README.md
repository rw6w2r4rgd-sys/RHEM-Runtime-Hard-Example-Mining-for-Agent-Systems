...
当前参考实现版本为 `v0.7.0`，日期 `2026-09-12`。本版新增默认关闭的冬眠机制：观察期、低功耗冬眠、同类错误复发唤醒、人工唤醒和人工批准回收；不改变未启用冬眠时的旧行为。`v0.7.0` 的 Zenodo 版本 DOI 为 `10.5281/zenodo.22721810`；`v0.6.0` 的独立版本 DOI 尚未生成，归档前引用 `v0.6.0` 请使用概念 DOI。完整变更见 [CHANGELOG.md](CHANGELOG.md)。
...
`v0.7.0` 的版本 DOI，固定对应冬眠生命周期版本：

```text
徐应生. (2026). RHEM — Runtime Hard-Example Mining for Agent Systems (v0.7.0).
Zenodo. https://doi.org/10.5281/zenodo.22721810
```
...
引用 `v0.7.0` 时使用版本 DOI `10.5281/zenodo.22721810`；引用 `v0.6.0` 且尚未完成版本归档时使用概念 DOI `10.5281/zenodo.22681163`；引用 `v0.5.1` 时使用 `10.5281/zenodo.22719758`；引用 `v0.5.0` 时使用 `10.5281/zenodo.22719697`；引用 `v0.4.0` 时使用 `10.5281/zenodo.22719563`；引用 `v0.3.0` 时使用 `10.5281/zenodo.22719509`；引用项目所有版本时使用概念 DOI `10.5281/zenodo.22681163`。
